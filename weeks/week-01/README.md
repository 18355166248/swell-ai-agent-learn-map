...
- [ ] JSON 输出约束（structured output / response_format）
- [ ] Function Calling / Tool Calling 是什么（了解即可，第 7 周深入）
- [ ] Temperature、max_tokens、context window 的意义
